...
-- );
--
-- INSERT INTO "user" (name, surname, phone, login, password_hash, role, address, coordinate_address_x, coordinate_address_y) VALUES
--     ('Rudy', 'Juliani', '555', 'login', 'passw', 'userrole', 'address', 55.66, 667.55),
--     ('Tom', 'Brian', '888', 'login', 'passw', 'userrole', 'address', 55.66, 667.55);
-- --
-- COMMIT;
